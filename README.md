...
- GitHub / Gitee 短描述：`30 道题，从 5 大模型、15 个维度测出你的设计人格。`
- 仓库长描述：`一个面向设计师群体的趣味人格测试网站，通过 30 道题从视觉信仰、需求应对、协作关系、创意驱动、工具共生五个模型分析你的设计人格类型。`
- OG 标题：`DBTI · 设计师人格测试`
- OG 描述：`一个面向设计师群体的趣味人格测试网站，通过 30 道题从 5 大模型、15 个维度分析你的设计人格类型。`
