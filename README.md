...
>
> 30 道题，从 5 个模型、15 个维度拆出你在开稿起手、改稿抗压、接需求拆招、讲方案控场和赶死线保交付时的默认出手。
>
...
- GitHub / Gitee 短描述：`30 道题，从 5 个模型、15 个维度拆出你在设计流程里的默认出手。`
- 仓库长描述：`一个面向设计师群体的趣味人格测试网站，把开稿起手、改稿渡劫、需求拆招、方案过会和工具共创这些高频反应，拆成像素结界、改稿渡劫、嘴替战力、灵感上头、外挂共生五个模型来测。`
- OG 标题：`DBTI · 设计师人格测试`
